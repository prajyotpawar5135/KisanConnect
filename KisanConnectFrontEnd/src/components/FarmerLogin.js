...
function FarmerLogin() {
  const myStyle = {
    backgroundImage:
      "url('https://images.unsplash.com/photo-1586771107445-d3ca888129ff?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGFncmljdWx0dXJlfGVufDB8fDB8fHww&w=1000&q=80')",
    height: "100vh",
    marginTop: "0px",
  ...
  var onSubmit = (e) => {
    ...
    axios
      .post("http://localhost:8080/farmer/login", {
