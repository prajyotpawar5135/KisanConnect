            ...
            <div class="container text-center text-md-start mt-5">
              <div class="row mt-3">
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                  <h6 class="text-uppercase fw-bold">KisanConnect</h6>
                  <hr
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                  ...
                  />
                  <p>
                    <i class="fas fa-home mr-3"></i> Help Desk No.: 4444 444
                    8888
                  </p>
                  <p>
                    <i class="fas fa-envelope mr-3"></i> kisanconnect@example.com
                  </p>
                  <p>
                    <i class="fas fa-phone mr-3"></i> Fax: +91-22- 78787878
                  </p>
                  <p>
