...
function FarmerReg() {
  const myStyle = {
    backgroundImage:
      "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTynaa38zUJRTCLlAh5g4jwJo3wtAMTvndiiuDxORyjeJ7dRAz0YRttSqcPPVTQruQzRtE&usqp=CAU')",
    height: "10vh",
    marginTop: "0px",
  ...
  const myStyle1 = {
    backgroundImage: "url('https://i.pinimg.com/564x/65/4c/0d/654c0d38952cf637db2f45646792aa5f.jpg')",
  ...
  const handleSubmit = (e) => {
    ...
    if (isvalid) {
      axios
        .post("http://localhost:8080/farmer/Registration", {
